    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="modal-title">Form Sifat</h5>
                ...
                <div class="modal-body">
                    <div class="card-body">
                        <div class="form-group">
                            <label>Kode Sifat: <span class="text-danger">*</span></label>
                            <input type="text" class="form-control" id="kode_sifat" name="kode_sifat" placeholder="Masukkan kode sifat" onchange="remove(id)">
                        </div>
                        <div class="form-group">
                            <label>Nama Sifat: <span class="text-danger">*</span></label>
                            <input type="text" class="form-control" id="nama_sifat" name="nama_sifat" placeholder="Masukkan nama unit" onchange="remove(id)">
                        </div>
                        <div class="form-group">
