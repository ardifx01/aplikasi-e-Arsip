    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-header">
                <h5 class="modal-title" id="modal-title">Form Surat Keluar</h5>
                ...
                <div class="modal-body">
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="koresponden" name="koresponden" placeholder="Masukkan koresponden" onchange="remove(this.id)" value="<?= old('koresponden') ?>">
                        </div>

                        <div class="form-group">
                            <label for="no_surat">Nomor Surat: <span class="text-danger">*</span></label>
                            <input type="text" class="form-control" id="no_surat" name="no_surat" placeholder="Masukkan nomor surat" onchange="remove(this.id)" value="<?= old('no_surat') ?>">
                        </div>
                        ...
                        <div class="form-group">
                            <label for="id_unit">Nama Unit Bagian: <span class="text-danger">*</span></label>
                        ...
                        <div class="form-group">
                            ...
                            <textarea rows="3" class="form-control" id="keterangan" name="keterangan" placeholder="Masukkan keterangan"><?= old('keterangan') ?></textarea>
                        </div>
