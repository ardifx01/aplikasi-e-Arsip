    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="modal-title">Form Klasifikasi</h5>
                ...
                <div class="modal-body">
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="kode_klasifikasi" name="kode_klasifikasi" placeholder="Masukkan kode klasifikasi" onchange="remove(id)">
                        </div>
                        <div class="form-group">
                            <label>Nama Klasifikasi: <span class="text-danger">*</span></label>
                            <input type="text" class="form-control" id="nama_klasifikasi" name="nama_klasifikasi" placeholder="Masukkan nama klasifikasi" onchange="remove(id)">
                        </div>
                        <div class="form-group">
